...
import type { IconAliases, IconOptions } from '@/icons/icons';
...
/**
 * Adds styles, appliedOptions and primeVueProps
 */
export const usePrimeVueLabel = <
  T extends {
...
>(
  ...
  const primeVueProps = (path: string) => {
    const props = get(appliedOptions.value?.primevue, path);
...
/** @deprecated Use usePrimeVueLabel instead */
export const useVuetifyLabel = usePrimeVueLabel;
...
/** @deprecated Use usePrimeVueControl instead */
export const useVuetifyControl = usePrimeVueControl;
 ...
 */
export const usePrimeVueLayout = <
  T extends { config: any; uischema: UISchemaElement },
...
/** @deprecated Use usePrimeVueLayout instead */
export const useVuetifyLayout = usePrimeVueLayout;

/**
 * Adds styles, appliedOptions and childUiSchema
 */
export const usePrimeVueArrayControl = <
  T extends {
    label: string;
    required: boolean;
    config: any;
...
/** @deprecated Use usePrimeVueArrayControl instead */
export const useVuetifyArrayControl = usePrimeVueArrayControl;

/**
 * Adds styles and appliedOptions
 */
export const usePrimeVueBasicControl = <
  T extends { config: any; uischema: UISchemaElement },
  I extends {
    control: ComputedRef<T>;
  },
...
/** @deprecated Use usePrimeVueBasicControl instead */
export const useVuetifyBasicControl = usePrimeVueBasicControl;
...
export const useIcons = () => {
  const iconSet = computed<IconAliases>(() => {
    ...
    if (!icons) throw new Error('Missing PrimeVue Icons provide!');
