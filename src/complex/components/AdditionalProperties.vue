<template>
  <div v-if="control.visible">
    <div class="flex items-center gap-2 mb-2">
      <div v-if="additionalPropertiesTitle" class="font-semibold">
        {{ additionalPropertiesTitle }}</div
      >
      <json-forms
      ...
      <Button
        ...
        @click="addProperty"
        v-tooltip.bottom="translations.addTooltip"
      />
    </div>
    <div v-for="element in additionalPropertyItems" :key="`${element.propertyName}`">
      <div class="flex items-center gap-2 mb-2">
        <div class="flex-1">
          <dispatch-renderer
        ...
        <div v-if="control.enabled">
          <Button
            ...
            v-tooltip.bottom="translations.removeTooltip"
          />
        </div>
      </div>
    </div>
