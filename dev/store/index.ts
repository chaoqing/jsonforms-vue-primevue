...
const appstore = reactive({
  ...
  rtl: false,
  layout: useLocalStorage('primevue-example-layout', ''),
  formOnly: useHistoryHashQuery('form-only', false as boolean),
  activeTab: useHistoryHashQuery('active-tab', 0 as number),
  dark: useLocalStorage('primevue-example-dark', false),
  theme: useLocalStorage('primevue-example-theme', 'light'),
  drawer: useHistoryHashQuery('drawer', true as boolean),
  settings: false,
  variant: useLocalStorage('primevue-example-variant', ''),
  iconset: useLocalStorage('primevue-example-iconset', 'mdi'),
  blueprint: useLocalStorage('primevue-example-blueprint', 'md1'),
  ...
  jsonforms: {
    ...
    locale: useLocalStorage('primevue-example-locale', 'en'),
  },
});
